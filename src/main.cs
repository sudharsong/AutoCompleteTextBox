...
//    {
//        buffer = new byte[30];
//        BinaryPrimitives.WriteInt32BigEndian(buffer.AsSpan(0, 4), 26);
...
//        buffer[17] = 0;
//        BinaryPrimitives.WriteInt16BigEndian(buffer.AsSpan(18, 2), 75);
//        BinaryPrimitives.WriteInt16BigEndian(buffer.AsSpan(20, 2), 0);
//        BinaryPrimitives.WriteInt16BigEndian(buffer.AsSpan(22, 2), 0);
//        buffer[24] = 0;
//        BinaryPrimitives.WriteInt32BigEndian(buffer.AsSpan(25, 4), 120);
//        buffer[29] = 0;
//    }
//    else
//    {
